...
public class Health : MonoBehaviour
{
	...
	public void Die()
	{
		...
		if (hasComponent(gameObject.GetComponent<EnemyAI>()))
        {
			gameObject.GetComponent<EnemyAI>().GrantStats();
		} else if (hasComponent(gameObject.GetComponent<BossAI>()))
        {
			gameObject.GetComponent<BossAI>().GrantStats();
		}
		Destroy(gameObject);
	}
